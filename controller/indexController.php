	...
	class indexController extends indexDAO{
		...
		function box_saludo1(){
			...
			echo '<div class="col-lg-12">
                    ...
                    <p>Esta página pretende dar a nuestros clientes la facilidad de hacer sus <a href="cotizacion.php">cotizaciones</a> en línea, para que a la hora de acercarse a hacer su compra sea más rápido y efectivo su proceso de construcción o ejecución de su proyecto. Infórmese acerca de nuestros materiales en la sección de <a href="catalogo.php">catálogo</a>, para que tenga presente a la hora de hacer la cotización todas las características de los productos, tales como el precio entre otros.</p>
